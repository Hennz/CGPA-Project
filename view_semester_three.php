...
{
 $sql_query="DELETE FROM y2semester1 WHERE studentNO=".$_GET['delete_id'];
...
<table id="Data">
        <thead>
            <tr>
                ...
                <th>Artificial Interigence</th>
                <th>Computer Nertworks</th>
                <th>Discrete Math </th>
                <th>Formal Methods/Software Eng</th>
                <th>GPA</th>
                <th>Edit</th>
                <th>Delete</th>
            </tr>
        ...
        <tbody>
             <?php
             $sql_query="SELECT * FROM y2semester1";
             ...
             while($row=mysql_fetch_row($result_set))
             {
              ?>
                    ...
                    <td align="center"><a title ="Edit" href="javascript:edit_id('<?php echo $row[1]; ?>')"><img src="images/b_edit.png" align="EDIT" /></a></td>
        <td align="center"><a title ="Delete" href="javascript:delete_id('<?php echo $row[1]; ?>')"><img src="images/b_drop.png" align="DELETE" /></a></td>
                    </tr>
                    <?php
             }
             ?>
...
<script type="text/javascript">
    ...
    function delete_id(id)
    {
     ...
     {
      window.location.href='view_semester_three.php?delete_id='+id;
     }
}
