...
{
 $sql_query="DELETE FROM y2semester2 WHERE studentNO=".$_GET['delete_id'];
...
<table id="Data">
        <thead>
            <tr>
                ...
                <th>Automata,Complexity & Computability</th>
        ...
        <tbody>
             <?php
             $sql_query="SELECT * FROM y2semester2";
...
<script type="text/javascript">
 	function edit_id(id)
    {
     ...
     {
      window.location.href='update-semester-four-data.php?edit_id='+id;
     }
    }
    function delete_id(id)
    {
     ...
     {
      window.location.href='view_semester_four.php?delete_id='+id;
     }
}
