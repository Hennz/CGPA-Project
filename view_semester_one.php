...
{
 $sql_query="DELETE FROM y1semester1 WHERE studentNO=".$_GET['delete_id'];
...
<table id="Data">
        <thead>
            <tr>
                ...
                <th>Comm Skills</th>
                <th>Comp Arch</th>
                <th>Individual proj</th>
                <th>Structured Programming </th>
                <th>Comp Lit</th>
                <th>Grade Point Ave(GPA)</th>
                <th>Edit</th>
                <th>Delete</th>
            </tr>
        </thead>
        <tbody>
             <?php
             $sql_query="SELECT * FROM y1semester1";
...
<script type="text/javascript">
 	function edt_id(id)
    {
     ...
     {
      window.location.href='update-semester-one-data.php?edit_id='+id;
     }
    }
    ...
    function delete_id(id)
    {
     ...
     {
      window.location.href='view_semester_one.php?delete_id='+id;
     }
}
