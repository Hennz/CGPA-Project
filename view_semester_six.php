...
{
 $sql_query="DELETE FROM y3semester2 WHERE studentNO=".$_GET['delete_id'];
...
<table id="Data">
        <thead>
            <tr>
                ...
                <th>CompilerDesign</th>
                <th>Cs Project 2</th>
                <th>Cs Security / Data Warehouse</th>
                <th>Distributed System/Emerging Trends</th>
                <th>GPA</th>
                <th>Edit</th>
                <th>Delete</th>
            </tr>
        ...
        <tbody>
             <?php
             $sql_query="SELECT * FROM y3semester2";
...
<script type="text/javascript">
    ...
    function delete_id(id)
    {
     ...
     {
      window.location.href='view_semester_six.php?delete_id='+id;
     }
}
