...
{
 $sql_query="DELETE FROM y1semester2 WHERE studentNO=".$_GET['delete_id'];
...
<table id="Data">
        <thead>
            <tr>
                ...
                <th>SAAD</th>
                <th>Calculus 1</th>
                <th>Object Oriented prog</th>
                <th>Numerical Analysis 1 </th>
                <th>DIM</th>
        ...
        <tbody>
             <?php
             $sql_query="SELECT * FROM y1semester2";
...
<script type="text/javascript">
    ...
    function delete_id(id)
    {
     ...
     {
      window.location.href='view_semester_two.php?delete_id='+id;
     }
}
